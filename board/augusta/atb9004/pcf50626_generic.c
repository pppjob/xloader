...
static void pcf50626_DCD1_power_supply(u32 voltage, int mode)
{
	u32 reg1, reg3;
...
static void pcf50626_DCD2_power_supply(u32 voltage, int mode)
{
	u32 reg1, reg3;
...
{
	printf("set arm core to 1.3V.\n");
	pcf50626_DCD1_power_supply(1300, 1);
	printf("set mddr to 1.8V.\n");
